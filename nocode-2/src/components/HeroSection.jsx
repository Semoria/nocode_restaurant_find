...
const HeroSection = ({ onAddressConfirm }) => {
  ...
  const handleAutoLocate = async () => {
    ...
    try {
      ...
      const locationInfo = await geocodeAddress(data.city);
        ...
        <div className="flex flex-col sm:flex-row gap-3 max-w-2xl mx-auto">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={isLoading || isLocating}
              className="px-4 py-2.5 bg-brand-primary text-white rounded-lg hover:bg-brand-accent transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLocating ? (
                <>
            ...
            <button
              ...
              className="px-6 py-2.5 bg-brand-primary text-white rounded-lg hover:bg-brand-accent transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
                  <Loader2 className="h-4 w-4 animate-spin" />
